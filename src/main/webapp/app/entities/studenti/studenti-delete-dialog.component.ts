...
export class StudentiDeleteDialogComponent {
    ...
    constructor(private studentiService: StudentiService, public activeModal: NgbActiveModal, private eventManager: JhiEventManager) {}
...
export class StudentiDeletePopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ studenti }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(StudentiDeleteDialogComponent as Component, { size: 'lg', backdrop: 'static' });
                this.ngbModalRef.componentInstance.studenti = studenti;
