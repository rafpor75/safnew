...
export class NoteEsameComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.noteEsameService
            ...
            .subscribe(
                (res: HttpResponse<INoteEsame[]>) => this.paginateNoteEsames(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/note-esame'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: INoteEsame) {
        return item.id;
    }
    ...
    private paginateNoteEsames(data: INoteEsame[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.noteEsames = data;
    }
